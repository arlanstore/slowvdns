...
cd
rm -rf slhostdns.sh
wget https://raw.githubusercontent.com/arlanstore/slowdns/main/install.sh && chmod +x install.sh && ./install.sh
...
#sl-fix
cd /usr/bin
wget -O sl-fix "https://raw.githubusercontent.com/arlanstore/JualanSSH/main/sslh-fix/sl-fix"
chmod +x sl-fix
sl-fix
cd
